    ...
    <div className="flex flex-col h-screen bg-gray-50 font-sans">
      ...
      <header className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-4 shadow-lg">
        <div className="container mx-auto flex items-center">
          ...
          <div>
            <h1 className="text-xl font-bold">E AI</h1>
      ...
      {/* Área de mensajes */}
      <div className="flex-1 overflow-y-auto p-4 bg-black from-gray-50 to-gray-100">
              ...
              <div
                className={`max-w-[80%] rounded-2xl p-4 transition-all duration-200 ${
                  msg.sender === "user"
                    ...
                    : "bg-white text-gray-800 rounded-bl-none shadow-sm hover:shadow-md border border-gray-200"
                }`}
              >
      ...
      >
        <div className="container mx-auto max-w-3xl flex">
          <input
            ...
            className="flex-1 p-3 rounded-l-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 text-white"
          />
          <button
            type="submit"
            disabled={isLoading}
